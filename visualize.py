...
def compute_ratemaps( model, trajectory_generator, polygon, options, res=20, n_avg=None, Ng=512, idxs=None ):
...
def save_ratemaps(model, trajectory_generator, polygon, options, step, res=20, n_avg=None):
